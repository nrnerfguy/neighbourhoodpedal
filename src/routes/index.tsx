 ...
 *
 *  Tries `/favicon.ico` from the static public/ folder first (Vercel serves
...
/** Tries the real `public/favicon.ico` first; falls back to the inline brand
 *  mark so the icon is never blank even if favicon hasn't been uploaded yet. */
 ...
 *  Used as the fallback when `public/favicon.ico` isn't deployed (yet). */
